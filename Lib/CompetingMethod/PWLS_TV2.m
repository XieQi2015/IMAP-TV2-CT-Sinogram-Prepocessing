function  [Y,var,Z] = PWLS_TV2(SignoP,I0,beta,Par)
...
t        = 1;
stoption = 0;
difZ     = diff2T_ND_GPU2(Z-Q/mu,sizeS);
Y        = Y_ini;
X        = Y;
% normY    = norm(Y(:));
i        = 1;
